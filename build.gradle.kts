...
dependencies {
    ...
    // Silence javac warnings from transitive annotations-only references.
...
loom {
    accessWidenerPath = file("src/main/resources/george-client.accesswidener")
}
