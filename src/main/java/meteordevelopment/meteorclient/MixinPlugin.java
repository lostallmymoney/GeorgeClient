...
public class MixinPlugin implements IMixinConfigPlugin {
    ...
    private static boolean isXaeroPlusPresent;
    private static boolean isBaritoneApiPresent;
    private static boolean isBobbyPresent;
    ...
    public void onLoad(String mixinPackage) {
        ...
        isXaeroPlusPresent = FabricLoader.getInstance().isModLoaded("xaeroplus");
        isBaritoneApiPresent = isClassPresent("baritone.api.BaritoneAPI");
        isBobbyPresent = FabricLoader.getInstance().isModLoaded("bobby");
    ...
    public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        ...
        else if (mixinClassName.startsWith(mixinPackage + ".bobby")) {
            return isBobbyPresent;
        }
        else if (mixinClassName.startsWith(mixinPackage + ".xaeroplus")) {
            return isXaeroPlusPresent && isBaritoneApiPresent;
        }
