...
public class MeteorClient implements ClientModInitializer {
    public static final String MOD_ID = "george-client";
    public static final String LEGACY_MOD_ID = "meteor-client";
    ...
    public static final File LEGACY_FOLDER = FabricLoader.getInstance().getGameDir().resolve(LEGACY_MOD_ID).toFile();
    ...
    public void onInitializeClient() {
        ...
        if (!FOLDER.exists() && LEGACY_FOLDER.exists()) {
            try {
                Files.move(LEGACY_FOLDER.toPath(), FOLDER.toPath());
                LOG.info("Migrated legacy config folder from {} to {}.", LEGACY_MOD_ID, MOD_ID);
            } catch (Exception e) {
                LOG.warn("Failed to migrate legacy config folder from {} to {}.", LEGACY_MOD_ID, MOD_ID, e);
            }
        }
