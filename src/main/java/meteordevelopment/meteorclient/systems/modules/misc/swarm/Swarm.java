...
public class Swarm extends Module {
    ...
    public Swarm() {
        super(Categories.Misc, "swarm", "Allows you to control multiple instances of George Client from one central host.");
    }
    ...
    public WWidget getWidget(GuiTheme theme) {
        ...
        guide.action = () -> error("No George Client documentation URL is configured.");
