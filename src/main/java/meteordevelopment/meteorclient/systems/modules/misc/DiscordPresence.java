...
public class DiscordPresence extends Module {
    ...
    private final Setting<List<String>> line2Strings = sgLine2.add(new StringListSetting.Builder()
        ...
        .defaultValue("George on Crack!", "{round(server.tps, 1)} TPS", "Playing on {server.difficulty} difficulty.", "{server.player_count} Players online")
    ...
    public DiscordPresence() {
        super(Categories.Misc, "discord-presence", "Displays George Client as your presence on Discord.");
    ...
    private void onTick(TickEvent.Post event) {
        ...
        if (Utils.canUpdate()) {
            ...
            if (!lastWasInMainMenu) {
                ...
                else if (mc.currentScreen instanceof WidgetScreen) rpc.setState("Browsing George's GUI");
    ...
    public WWidget getWidget(GuiTheme theme) {
        ...
        help.action = () -> error("No George Client documentation URL is configured.");
