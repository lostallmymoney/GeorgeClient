...
public class Blur extends Module {
    ...
    private final Setting<Boolean> meteor = sgScreens.add(new BoolSetting.Builder()
        .name("meteor")
        .description("Applies blur to George Client screens.")
        .defaultValue(true)
        .build());
    ...
    private static final FixedUniformStorage<BlurUniformData> UNIFORM_STORAGE = new FixedUniformStorage<>("George - Blur UBO", UNIFORM_SIZE, 6);
