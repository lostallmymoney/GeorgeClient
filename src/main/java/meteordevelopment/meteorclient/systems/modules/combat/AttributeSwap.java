...
public class AttributeSwap extends Module {
    ...
    private int getSmartSlot(Entity target) {
        ...
        boolean hasFireResistance = livingTarget != null && (livingTarget.hasStatusEffect(StatusEffects.FIRE_RESISTANCE) || hasFireProtectionArmor(livingTarget));
        double armor = livingTarget != null ? livingTarget.getAttributeValue(EntityAttributes.ARMOR) : 0;
        float health = livingTarget != null ? livingTarget.getHealth() : 0;
