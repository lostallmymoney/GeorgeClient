    ...
    private enum State {
        ...
        protected int findHotbarSlot(HighwayBuilder b, boolean replaceTools) {
            ...
            for (int i = 0; i < 9; i++) {
                ...
                if (replaceTools && NewAutoTool.isTool(itemStack)) return i;
        ...
        protected int findAndMoveBestToolToHotbar(HighwayBuilder b, BlockState blockState, boolean noSilkTouch) {
            ...
            for (int i = 0; i < b.mc.player.getInventory().getMainStacks().size(); i++) {
                double score = NewAutoTool.getScore(b.mc.player.getInventory().getStack(i), blockState, false, false, false, NewAutoTool.EnchantPreference.None, itemStack -> {
